"""
Script for generating the results of Section 6.4. SAMD, Figure 6b.
...
theta_opt_list = data['theta_opt_list']
loss_opt_list = data['loss_opt_list']

# %%%%%%%%%%%%%%%%%%%%%%%%%%% Solve IO approach %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
approaches = ['SAMD-1', 'SAMD-2', 'SAMD-5', 'SAMD-10', 'SAMD-25', 'SAMD-50']
...
for approach in approaches:
    ...
    elif approach == 'SAMD-2':
        step = 'exponentiated'
        batch = 0.04
        time_limit = time_limit_approx
    elif approach == 'SAMD-5':
        step = 'exponentiated'
        batch = 0.1
        time_limit = time_limit_approx
    elif approach == 'SAMD-10':
        step = 'exponentiated'
        batch = 0.2
        time_limit = time_limit_approx
    elif approach == 'SAMD-25':
        step = 'exponentiated'
        batch = 0.5
        time_limit = time_limit_approx
    elif approach == 'SAMD-50':
        step = 'exponentiated'
        batch = 1
        time_limit = time_limit_approx
